    ...
    <section className='w-full py-10 bg-primary-200'>
      ...
      <div className='flex gap-5 mt-5 overflow-auto'>
        <div className='min-w-full md:min-w-[0px] md:flex-1 h-[200px] relative'>
          <Image fill src="/images/classesGraphic1.png" alt="Gym center image" className='object-cover' />
        </div>
        <div className='min-w-full md:min-w-[0px] md:flex-1 h-[200px] relative'>
          <Image fill src="/images/classesGraphic2.png" alt="Gym center image" className='object-cover' />
            
        </div>
        <div className='min-w-full md:min-w-[0px] md:flex-1 h-[200px] relative'>
        <Image fill src="/images/classesGraphic3.png" alt="Gym center image" className='object-cover' />
          
        </div>
        <div className='min-w-full md:min-w-[0px] md:flex-1 h-[200px] relative'>
        <Image fill src="/images/classesGraphic4.png" alt="Gym center image" className='object-cover' />
